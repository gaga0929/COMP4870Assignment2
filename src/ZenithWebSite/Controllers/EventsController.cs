...
namespace ZenithWebSite.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Events.Include(a => a.ActivityDetails);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,ActivityId,CreationDate,EventEnd,EventStart,IsActive,Username")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
